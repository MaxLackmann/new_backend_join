...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('join_app', '0003_alter_subtask_task_alter_task_priority'),  # Ersetze '0003_alter_subtask_task_alter_task_priority' durch den tatsächlichen Namen der vorherigen Migrationsdatei
    ]
